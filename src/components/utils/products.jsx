  ...
  Напої: [
    {
      ...
      description: "Напій кока-кола. Розмір: 1 літр",
      price: 50,
    },

    {
      ...
      name: "Вода",
      category: "напої",
      image: images["Моршинська.png"],
      description: "Вода негазована Моршинська. Розмір: 0.5 літрів",
      price: 35,
    },
  ],
};
